...
const getSubmissionIndicator = (performance: evaluatedSubmissionPerformance) => {
	const indicators = {
...
export default function useIndicator(){
	...
	const performanceTypes = {
		...
		submission: (performance: postedPerformance) => getSubmissionIndicator(performance as evaluatedSubmissionPerformance),
		// eslint-disable-next-line
