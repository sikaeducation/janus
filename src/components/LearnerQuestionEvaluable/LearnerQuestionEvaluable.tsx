...
export default function LearnerQuestionEvaluable({
	performance,
}: props){
	const [
		showForm,
	...
	const previousPerformances = getPreviousEvaluations(performance) as unknown as evaluatedQuestionPerformance[];
