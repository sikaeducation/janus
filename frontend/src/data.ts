            ...
            activities: [
              {
                ...
                next: {
                  slug: "websites/websites-1/html-div-span-exercises",
                  label: "<div> and <span> Exercises",
                },
              },
              {
                id: 2,
                type: "exercise",
                full_label: "HTML: <div> and <span>: Exercise",
                short_label: "<div> & <span> Exercises",
                slug: "html-div-span-exercises",
                section_id: 1,
                unit_id: 1,
                content: "# HTML: <div> and <span> Exercises\nGo here",
                next: {
                  slug: "websites/websites-1/css-block-layout",
                  label: "CSS: Block Layout",
                },
              },
              {
                id: 3,
                type: "topic",
                full_label: "CSS: Block Layout",
                short_label: "Block Layout",
